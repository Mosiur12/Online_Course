        ...
        <div class="col-sm-12">
            <div class="page-header-title">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="{{route('student.courses.index')}}">All Course's</a></li>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        @php
                                            $category = \App\Category::where('id', $course->category_id)->first();
                                            $user = \App\User::where('id', $course->instructor_id)->first();
                                        @endphp

                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="example-email">Category</label>
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$category->name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$user->name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <a href="{{route('student.course.content', $course->id)}}" class="btn btn-success waves-effect waves-light">Continue course</a>
                                            </div>
                                        </div>
                                    </form>
                                </div> <!-- panel-body -->
