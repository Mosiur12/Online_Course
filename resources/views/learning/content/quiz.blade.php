...
@section('title', 'Course Content | Quiz')
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    @php
                        $chapterName = \App\Chapter::where('id', $quiz->chapter_id)->select('name', 'id')->first();
                    @endphp
                    <h3 class="panel-title">{{$chapterName->name}} || {{$quiz->title}}</h3>
                </div>
                            ...
                            <div class="col-md-4" style="display: inline">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Submit Answer</td>
                                        <td>
                                            <form role="form" action="{{route('student.course.quiz.upload')}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <input type="hidden" name="instructor_id" value="{{$quiz->instructor_id}}">
                                                <input type="hidden" name="chapter_id" value="{{$chapterName->id}}">
