...
@section('title', 'Course Content | Final Exam Result')

@section('main-content')
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">{{$final->title}}</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="{{route('student.dashboard')}}">Dashboard</a></li>
                    <li><a href="{{route('student.courses.index')}}">All course</a></li>
                    <li class="active">Final Exam Result</li>
                </ol>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">{{$course->title}} || {{$final->title}}</h3>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="display: inline">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td style="width: 15%;">Exam Marks</td>
                                        <td>{{$final->marks}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 15%;">Exam Time (In Minutes)</td>
                                        <td>{{$final->time}}</td>
                                    </tr>
                                    <tr>
