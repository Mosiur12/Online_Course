    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">{{session('course_name')}}</h4>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title" style="display: inline"> <span id="lectureTitle">Lecture Name</span></h3>
                    <a style="float: right" id="courseView" class="btn btn-success" href="#">Mark As Complete</a>
                </div>
                <div class="panel-body w-100">
                    ...
                    <div class="text-center m-t-5">
                        ...
                        <a href="#" id="resource" class="btn btn-success" download> <i class="fa fa-download"></i> Resource</a>
                    </div>
                </div> <!-- panel-body -->
            </div> <!-- panel -->
