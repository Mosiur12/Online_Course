...
@section('title', 'Quiz Participant List')
@push('css')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">Quiz Participant</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="{{route('instructor.dashboard')}}">Dashboard</a></li>
                    <li class="active">Quiz Participant</li>
                </ol>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Quiz Participant</h3>
                </div>
                        ...
                        @else
                            @foreach($answerScripts as $key=>$answerScript)
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#quizMarkModel-{{$key}}">Upload Mark</button></td>
                                </tr>
                                @include('instructor.content._answer_script_modal')
                            @endforeach
                        @endif
                        </tbody>
                    </table>
