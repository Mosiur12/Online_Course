...
<div class="col-xs-6 col-sm-3 m-t-30">
    <div id="createQuizModal-{{$chapter->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form role="form" action="{{route('instructor.quizzes.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="myModalLabel">Quiz Form</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="marks" value="{{old('marks')}}" class="form-control @error('marks') is-invalid @enderror" id="ex1" placeholder="Enter Quiz marks">
                        </div>
                        @error('marks')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
