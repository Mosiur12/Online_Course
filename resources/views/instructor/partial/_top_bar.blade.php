<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{route('instructor.dashboard')}}" class="logo"><img src="{{asset('/')}}assets/images/logo_white_2.png" height="28" style="width: 94%;height: 45px;"></a>
            <a href="{{route('instructor.dashboard')}}" class="logo-sm"><img src="{{asset('/')}}assets/images/logo_sm.png" height="36"></a>
        </div>
    </div>
