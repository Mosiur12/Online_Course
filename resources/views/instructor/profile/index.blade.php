                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$contact->designation ? $contact->designation : ''}}" readonly>
                                            </div>
                                        </div>
                                       ...
                                       {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <a href="{{route('instructor.profileEdit')}}" class="btn btn-success waves-effect waves-light">Update Profile</a>
                                            </div>
                                        </div>
                                    </form>
                                </div> <!-- panel-body -->
