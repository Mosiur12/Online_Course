...
@section('title', 'Details Instructor')

@section('main-content')
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">Details Instructor</h4>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        if (isset($user->image)){
                            ...
                            $img = 'assets/images/img/student.jpg';
                        }
                        @endphp
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Instructor Name</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="example-email">Adress</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <a href="{{route('admin.instructors.edit', $user->id)}}" class="btn btn-success waves-effect waves-light">Edit</a>
                                            </div>
                                        </div>
                                    </form>
                                </div> <!-- panel-body -->
