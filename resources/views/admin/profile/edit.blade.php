        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <form role="form" action="{{route('admin.profileUpdate', $info->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <a href="{{route('admin.profile')}}" class="btn btn-success waves-effect waves-light">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
