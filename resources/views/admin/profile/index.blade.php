                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$contact->about_me}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$contact->designation}}" readonly>
                                            </div>
                                        </div>
...
--}}
                                       {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="url" id="example-email" name="example-email" class="form-control" value="{{$contact->facebook}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="url" id="example-email" name="example-email" class="form-control" value="{{$contact->youtube}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="url" id="example-email" name="example-email" class="form-control" value="{{$contact->twitter}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="url" id="example-email" name="example-email" class="form-control" value="{{$contact->instagram}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" id="example-email" name="example-email" class="form-control" value="{{$contact->whatsapp}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <a href="{{route('admin.dashboard')}}" class="btn btn-info waves-effect waves-light">Home</a>
                                                <a href="{{route('admin.profileEdit')}}" class="btn btn-success waves-effect waves-light">Update Profile</a>
                                            </div>
                                        </div>
                                    </form>
                                </div> <!-- panel-body -->
