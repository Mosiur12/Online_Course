...
class StudentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($data->save())
        {
            ...
            $info->save();
            Toastr::success('Student Successfully create', 'Success');
            return redirect()->route('admin.students.index');
        }else{
            Toastr::error('Student Failed to create', 'Error');
            return redirect()->route('admin.students.index');
        }
    ...
    public function show($id)
    {
        ...
        return view('admin.student.show', compact('user','contact'));
    }
    ...
    public function destroy($id)
    {
        ...
        if ($res){
            ...
            Toastr::error('Student fail to Deleted', 'Error');
        }
